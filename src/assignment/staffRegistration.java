	...
	public void start(Stage primaryStage) throws Exception {
     ...
     // Creating a Label
      ...
      //Label for Confirmed password
        ...
        Label lbldate_of_join = new Label("Join Date");
        lbldate_of_join.setLayoutX(20);
        lbldate_of_join.setLayoutY(300);
        lbldate_of_join.setFont(new Font("bold", 15)); 
        lbldate_of_join.setTextFill(Color.BLACK);
...
//        });
        ...
        btnSignin.setOnAction(event -> {
            ...
            if (password.length() < 6) {
                ...
                NewStaff customer = new NewStaff(0,username, password, address, phone_number, email_address,
        ...
        sidePane.getChildren().addAll(lblhead,lblusername,usernameField,lblpassword,passwordField,lblconfirmedpassword,confirmedpasswordField,lbladdress,addressField,lblphone,phoneField,lblemail,emailField,lbldate_of_join,datePicker,lblgender,r1,r2,r3,btnSignin);
 ...
 public boolean saveRecord(NewStaff person) {
		...
		String sql = "INSERT INTO staffs (username, pass_word, address, phone_number, email_address, join_date, gender) VALUES (?, ?, ?, ?, ?, ?, ?)";
		...
		try {
			...
			pstat.setDate(6, java.sql.Date.valueOf(person.getJoin_date()));
